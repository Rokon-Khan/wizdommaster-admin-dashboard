            ...
            <div className="px-4 sm:px-6">
                <div className="flex items-center justify-between h-14 sm:h-16">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-gray-300 to-gray-500 flex items-center justify-center overflow-hidden">
                            <div className="w-full h-full bg-gray-400"></div>
                        </div>
                        <div className="flex flex-col hidden sm:flex">
                            <span className="text-xs sm:text-sm font-medium text-gray-900">Alex</span>
                            <div className="flex items-center gap-1 sm:gap-2 text-[10px] sm:text-xs text-gray-600">
                                <span className="hidden md:inline">25 years old</span>
                                <span className="hidden md:inline">•</span>
                                <span className="hidden lg:inline">20.2y Metabolic age</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-xs sm:text-sm text-gray-700">
                        <span className="hidden sm:inline">{day} {month}, {dayOfWeek}</span>
